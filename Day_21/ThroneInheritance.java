...
class ThroneInheritance {
    ...
    /**
     * Constructor to initialize the ThroneInheritance with the king's name.
     *
    ...
    /**
     * Adds a new child to the given parent in the family tree.
     *
    ...
    /**
     * Marks a person as deceased in the family tree.
     *
     * @param name The name of the deceased person.
     */
    public void death(String name) {
        isDead.add(name);
    }

    // Retrieves the inheritance order of the family tree.
    ...
    // Depth-first search (DFS) to traverse the family tree and update the inheritance order.
